...
const groupAsset = (fileName: string) => `/group/${fileName}`
...
export const ATHLETISME_HERO_IMAGE    = athleticismAsset('acc%20image.jpeg')
...
export const GROUP_PHOTOS: string[] = [
  groupAsset('018d098d-e283-4850-a664-b862e8d9f6bf.jpg'),
  groupAsset('058bd6b0-aa7f-4b2e-b2f8-8d6dd225cbd9.jpg'),
  groupAsset('06cda809-94b8-4eb2-b0b1-d3898a44ea79.jpg'),
  groupAsset('0c773007-505f-4d49-ac21-2cd23c4a61b6.jpg'),
  groupAsset('18d878db-b719-4327-a03c-0969a525d36c.jpg'),
  groupAsset('5743d394-b577-42cf-b235-665f1d64c922.jpg'),
  groupAsset('735b77e7-f3b1-493f-b080-3cf19b680ab3.jpg'),
  groupAsset('736fbbb8-52a4-4db4-ae81-1007320e3cba.jpg'),
  groupAsset('7450a0a4-9383-4c0b-bbaf-f91d361526c1.jpg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.09.jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.10.jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.11.jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.12 (1).jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.12.jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.13.jpeg'),
  groupAsset('WhatsApp Image 2026-05-16 at 19.27.14.jpeg'),
  groupAsset('ad91dbc5-196f-4260-8af8-7f6c93d6f382.jpg'),
  groupAsset('c9a2f713-14dd-4738-bad4-25ae734c43c3.jpg'),
  groupAsset('e000dc5c-d7a6-4c6d-9714-ffe31c901208.jpg'),
  groupAsset('eaa6f431-1ba7-42bf-8423-c7743f2d5fa7.jpg'),
]
...
export const ALL_PHOTOS = [
  ...
  ...GROUP_PHOTOS.map(src => ({ src, category: 'association' as const })),
]
